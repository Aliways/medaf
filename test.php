  ...
  <div class="panel-body">
      ...
      <div class="form-group">
        <div class="row">
          <div class="col-md-3">
            ...
            <select id="form_need" name="scholarship_type" class="form-control input-sm" required>
              <option value="">- Select -</option>
              <option value="school_fees_reimbursement" required>School Fees Reimbursement</option>
              <option value="career_advancement_professional_certification" required>Career Advancement/Professional Certification</option>
              <option value="orphanage_assistanship" required>Orphanage Assistanship</option>
            </select>
          </div>
          <div class="col-md-3">
            <label for="inputEmail4">Full Name</label>
            <input type="text" class="form-control input-sm" id="inputEmail4" placeholder="Full Name" name="full_name" required>
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-3">
              ...
              <option value="">- Select -</option>
              <option value="islaam" required>Islaam</option>
    ...
    <div class="form-group">
      ...
      <div class="col-md-3">
        ...
        <input type="email" class="form-control input-sm" id="inputEmail4" name="email" placeholder="Email" required>
      </div>

      <div class="col-md-3">
        <label for="inputEmail4">Password</label>
        <input type="password" class="form-control input-sm" id="inputEmail4" name="password" placeholder="Password" required>
      </div>

      <div class="col-md-3">
        <label for="inputEmail4">Date of Birth</label>
        <input type="date" class="form-control input-sm" id="inputEmail4" name="date_of_birth" placeholder="Date of Birth" required>
      </div>
    ...
    <div class="form-group">
      <div class="row">
        ...
        <select name="state_of_origin" class="form-control input-sm" required>
          <option value="">- Select -</option>
      ...
      <div class="col-md-3">
        ...
        <input type="tel" class="form-control input-sm" id="inputEmail4" name="phone_number" placeholder="Phone Number" required>
      </div>

     <div class="col-md-3">
          <label for="inputEmail4">Islamic Organisation</label>
          <select name="islamic_organisation" class="form-control input-sm" required>
          <option value="">- Select -</option>
          <option value="advanced_centre_for_the_advocacy_development_and_empowerment_of_muslim_community" required>Advanced Centre for the Adovocacy,Development and Empowerment of Muslim Community(ACADEMY)</option>
          <option value="other" required>Others</option>
          </select>
      </div>
      <div class="col-md-3">
        <label for="inputEmail4">LGA Origin</label>
        <input type="text" class="form-control input-sm" name="local_government_area_of_origin" id="inputEmail4" placeholder="Local Government Area of Origin" required>
      </div>
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <textarea name="home_address" class="form-control input-sm" required></textarea>
        </div>

      <div class="col-md-3">
        <label for="inputEmail4">Name of Institution</label>
        <input type="text" class="form-control input-sm" name="name_of_institution" id="inputEmail4" placeholder="Name of Institution" required>
      </div>

      <div class="col-md-3">
        <label for="inputEmail4">Course of Study</label>
        <input type="text" class="form-control input-sm" name="course_of_study" id="inputEmail4" placeholder="Course of Study" required>
      </div>

      <div class="col-md-3">
        <label for="inputEmail4">Official Website of the Institution/Professional Body</label>
        <input type="text" class="form-control input-sm" name="official_website_of_the_institution" id="inputEmail4" placeholder="Official Website of the Institution/Professional Body" required>
      </div>
      </div>
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <select name="certificate_obtained" class="form-control input-sm" name="certificate_obtained" required>
            <option value="">- Select -</option>
        ...
        <div class="col-md-3">
          ...
          <input type="number" class="form-control input-sm" id="inputEmail4" name="expected_year_of_program_completion" placeholder="Expected year of Program Completion" required>
        </div>

        <div class="col-md-3">
          <label>Contact address of the Institution/Professional Body</label>
          <textarea name="contact_address_of_islamic_organisation" class="form-control" required></textarea>
        </div>

        <div class="col-md-3">
          <label>Personal Statement</label>
          <textarea name="personal_statement" class="form-control" required></textarea>
        </div>
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <textarea name="contact_address_of_the_institution" class="form-control" required></textarea>
        </div>
