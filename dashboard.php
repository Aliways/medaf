        	...
        	<div class="col-lg-4 mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				...
        				<div class="info ml-4">
        					<h3><a href="teacher-single.html">Maryam Ibrahim</a></h3>
        					<span class="position">Advisor</span>
        					<p class="ftco-social d-flex">
		                <a href="#" class="d-flex justify-content-center align-items-center"><span class="icon-twitter"></span></a>
		                <a href="#" class="d-flex justify-content-center align-items-center"><span class="icon-facebook"></span></a>
    		...
    		<div class="row">
                ...
                <p>The selection of a MEDAF Scholar is unique in its attention to a young person’s character. We believe that integrity, courage, grit and personal autonomy are better indicators of overall potential than standard academic measures. To discover these traits, we administer the most comprehensive and thorough scholarship selection process in Nigeria.</p>
			    		...
			    		<div class="btn-join ftco-animate">
			    			<p><a href="login.php" class="btn btn-primary py-3 px-4">Login</a></p>
			    		</div>
			    	</div>
    			</div>
    		</div>
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="article.php">The Global Village</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="article.php">The Importance of Education</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="article.php">How to standout at start of your UX Career</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="article.php">Leadership Training</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="article.php">Read 2 Lead Challenge</a></h3>
            ...
            <div class="blog-entry align-self-stretch">
             <!--  <a href="blog-single.html" class="block-20" style="background-image: url('images/image_3.jpg');"> -->
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="article.php">Conferences & Seminars</a></h3>
            ...
            <div class="blog-entry align-self-stretch">
             <!--  <a href="blog-single.html" class="block-20" style="background-image: url('images/image_3.jpg');"> -->
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="article.php">Muslim Youth Development Camps</a></h3>
            ...
            <div class="blog-entry align-self-stretch">
             <!--  <a href="blog-single.html" class="block-20" style="background-image: url('images/image_3.jpg');"> -->
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3" style="max-width: 250%"><a href="article.php">Carrer Orientation</a></h3>
            ...
            <div class="blog-entry align-self-stretch">
             <!--  <a href="blog-single.html" class="block-20" style="background-image: url('images/image_3.jpg');"> -->
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="article.php">Read 2Lead Challenge Winners</a></h3>
