<nav class="navbar navbar-expand-lg navbar-light ftco_navbar bg-light ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand text-dark" href="index.php"><img src="images/logo.png"><!-- <i class="flaticon-university"></i> -->MEDAF <br><small>Scholarship</small></a>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services</a>
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  ...
                  <a class="dropdown-item" href="leadership.php">Leadership Training</a>
                  <a class="dropdown-item" href="2lead_challenge.php">Read 2Lead Challenge</a>
                  <a class="dropdown-item" href="conferences.php">Conferences and Seminars</a>
          ...
          <li class="nav-item"><a href="contact.php" class="nav-link">Contact</a></li>
           <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                <a class="dropdown-item" href="apply_for_scholarship.php">Apply for scholarship</a>
                <a class="dropdown-item" href="volunteer.php">Register as a volunteer</a>
                <a class="dropdown-item" href="dev_camp.php">Development Camp</a>
                <a class="dropdown-item" href="trainingform.php">Leadership Training Form</a>
                <a class="dropdown-item" href="2lead_challenge.php">Read 2Lead Challenge</a>
              </div>
            </li>
