...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      ...
      <p>Some text..</p>
      <p>Sunt in culpa qui officia deserunt mollit anim id est laborum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.Gems Consulting Company Limited, a Gold Enterprise Resource Planning Microsoft Partner is aimed at exposing finance operators to the basics of Business Intelligence using Power BI reporting tool alongside with their business solution.
...
<div class="container">
  ...
  <form method="POST" action="db/blog.php">
    <div class="form-group">
      <label for="comment">Comment</label>
      <textarea class="form-control" rows="5" cols="4" id="comment" name="comment" style="width: 500px;" required=""></textarea><br>
      <label for="email">Name</label>
    <input type="text" class="form-control" name="name" style="width: 300px;" required=""><br>
     <label for="pwd">Email</label>
    <input type="email" class="form-control" name="email" style="width: 300px;" required="">
  </div>
  <div>
...
<!-- <div class="container">
  ...
  <form action="/action_page.php">
    <div class="form-group">
      <label for="comment">Comment:</label>
      <textarea class="form-control" id="comment" name="text" style="width: 500px;s"></textarea>
    </div>
    <button type="submit" class="btn btn-primary">Submit</button>
  </form>
</div> -->
      <!-- <a href="power_bi.php" class="btn btn-primary btn-sm" role="button">READ MORE</a> -->
    ...
    <!-- </div>
     <div class="card">
      <h5>Power BI Reporting For Finance Personnel Training 2019</h5>
      <h5><small>THURSDAY, 04 JULY 2019 BY <b style="color: #7F3E98"><a href="#">GMC</a></b></small></h5>
      <div style="height:200px;"><img src="images/blog/blog1.jpg" alt="Smiley face" width="700" height="200"></div><br>
      <p>Some text..</p>
  ...
  <div class="rightcolumn">
    <div class="card">
      ...
      <p>Gems Consulting Company Limited, a Gold Enterpr...</p><br><hr>
       ...
       <div style="height:100px;"><img src="images/img1.png" class="img-responsive img-center"  width="150" height="70"> <p><a href="#"></a><p style="color: #7F3E98"><a href="ux_career.php">How to standout at start of your UX Career</a></p></div><br>
      <p>Gems Consulting Company Limited, a Gold Enterpr...</p> <br><br>        
    </div>
  </div>
</div><br><br>
