      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-8">
            <h1 class="logo">  <a class="navbar-brand text-dark" href="/medaf/index.php"><img src="images/logo.png"><!-- <i class="flaticon-university"></i> -->MEDAF<br><small>Scholarship</small></a> </h1>
          </div>
