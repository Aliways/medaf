        ...
        <div class="row mb-5">
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
              <h2><a class="navbar-brand" href="index.php"> <img src="images/logo.png">MEDAF <br><small>Scholarship</small></a></h2>
              <p>Bank Details<br>0003011728<br>
                    Muslim Educational Aid Foundation<br>
                    Jaiz Bank</p>
              <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                <li class="ftco-animate"><a href="https://twitter.com/medaf2020" target="_blank" rel="me"><span class="icon-twitter"></span></a></li>
                <li class="ftco-animate"><a href="https://www.facebook.com/medaf2020/" target="_blank"  rel="me"><span class="icon-facebook"></span></a></li>
                <li class="ftco-animate"><a href="https://www.instagram.com/medafstudio/?hl=en" target="_blank" rel="me"><span class="icon-instagram"></span></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Inspiring Articles</h2>
